export const about = {
  ...
  values: {
    eyebrow: "How James works",
    items: [
      { title: "Listen first", text: "Every session starts with your story. James never assumes, he asks, then acts." },
      { title: "Explain clearly", text: "No jargon, no vague reassurances. You'll understand what's driving your pain and what you can do about it." },
      { title: "Never push through pain", text: "Everything is progressive and adapted to where your body is today. Comfort is the starting point, not a destination." },
      { title: "Build independence", text: "The goal is for you to need James less, not more. You leave with tools, not dependency." },
    ],
  },
  credentials: {
    eyebrow: "Background",
