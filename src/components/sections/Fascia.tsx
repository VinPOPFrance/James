  ...
  return (
    <section className="rounded-section border border-hairline bg-white px-6 py-14 md:px-12">
      <div className="mx-auto max-w-3xl text-center">
        <span className="mb-4 inline-block rounded-full border border-hairline bg-white px-6 py-2.5 text-[clamp(2rem,5vw,3.25rem)] font-bold leading-none text-muted">
          {t.badge}
        </span>
