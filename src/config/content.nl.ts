...
export const homeNl = {
  ...
  testimonials: {
    ...
    items: [
      {
        quote: "James is een uitstekende lichaamstherapeut. Ik heb hem nu 3 keer bezocht en elke keer heeft hij mijn klacht opgelost en mijn houding verbeterd. Een expert in zijn vakgebied, en gewoon een fijn persoon. Sterk aanbevolen.",
        tag: "Houding & pijn opgelost",
        name: "Danielle Hibbert",
        city: "Rotterdam",
        media: "testimonialDanielle",
      },
      {
        quote: "De passie van James is onmiskenbaar. Zijn grondige en heldere uitleg maakt sessies veel leerzamer en leuker dan bij welke fysiotherapeut dan ook. Aanrader voor iedereen, zowel voor herstel als preventie.",
        tag: "Beter dan fysiotherapie",
        name: "Jelle van Rossum",
        city: "Rotterdam",
        media: "testimonialShara",
      },
      {
        quote: "James is een echte lichaamstherapeut. Hij begrijpt hoe spieren en weefsels met elkaar samenhangen en neemt de tijd om de oorzaak van de pijn te vinden. Na een paar sessies voelt mijn schouder veel beter en beweegt mijn lichaam soepeler.",
        tag: "Oorzaak gevonden",
        name: "Ibrahim Mikati",
        city: "Rotterdam",
